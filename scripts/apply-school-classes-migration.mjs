/**
 * Aplica migração 027 (school_classes) no Supabase remoto.
 * Requer SUPABASE_DB_PASSWORD ou DATABASE_URL.
 *
 * Uso: SUPABASE_DB_PASSWORD=... npm run db:migrate:school-classes
 */
...
const sqlPath = resolve(process.cwd(), 'supabase/migrations/027_school_classes.sql')
...
console.log('Migração 027_school_classes aplicada com sucesso.')
